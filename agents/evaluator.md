...
Return a single evaluation artifact in your final message, exactly following `templates/evaluation.md` (Verdict / Blocking Findings / Non-Blocking Findings / Required Changes / Recommended Changes / Evidence). The orchestrator will write it to `sis-brain/tickets/<ticket>/evaluation-<iteration>.md`. Be concise and factual; 1–2 pages maximum.
