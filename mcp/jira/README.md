...
If the installed MCP does not support an operation, the harness documents the limitation and continues with the record in the brain (`skills/brain/SKILL.md`).
