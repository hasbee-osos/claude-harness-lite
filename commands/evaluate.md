...
1. Require the current `sis-brain/tickets/<ticket-id>/implementation-report-<iteration>.md` (see `artifacts` in `state.json`). If missing, tell the user to run `/implement` first.
