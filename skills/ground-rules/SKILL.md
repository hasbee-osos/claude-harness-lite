...
- **Read the relevant skills before acting** (`workspace`, `brain`, `jira-attachments`, `input-packets`, `repository-analysis`, `architecture`, `testing`, `characterization-testing`, `git-workflow`, `engineering-standards`, and the project skills: `springboot`, `angular`, `postgresql`).
